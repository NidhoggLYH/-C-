...
joblib.dump(scaler_X, 'scaler_X_SVR.save')
joblib.dump(scaler_y, 'scaler_y_SVR.save')
...
model_filename = 'best_svr_model.model'
...
plt.title('验证集上实际值与预测值的对比（SVR）', fontsize=16)
...
plt.title('验证集上实际值与预测值对比（SVR）', fontsize=16)
...
output_path = r"D:\2024数学建模\解压后\C题\测试集预测结果SVR最终.xlsx"
