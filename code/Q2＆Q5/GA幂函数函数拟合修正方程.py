...
from sklearn.metrics import mean_squared_error, root_mean_squared_error, max_error, r2_score
...
# 定义斯坦麦茨方程函数
def steinmetz_equation(temperature, frequency, B_max, k, alpha, beta, gamma):
    """
    计算斯坦麦茨方程的磁芯损耗。
    ...
    磁芯损耗 (W/m³)
    """
    P = k * (frequency ** alpha) * (B_max ** beta) * (temperature ** gamma)
    return P
...
toolbox.register("individual", tools.initCycle, creator.Individual,
                 (toolbox.attr_float_k, toolbox.attr_float_alpha, toolbox.attr_float_beta, toolbox.attr_float_gamma), n=1)
...
k_best, alpha_best, beta_best, gamma_best = best_individual
y_pred_train = steinmetz_equation(x_train['温度，oC'],x_train['频率，Hz'],x_train['磁通密度峰值'],k_best, alpha_best, beta_best, gamma_best)
y_pred_test = steinmetz_equation(x_test['温度，oC'],x_test['频率，Hz'],x_test['磁通密度峰值'],k_best, alpha_best, beta_best, gamma_best)
