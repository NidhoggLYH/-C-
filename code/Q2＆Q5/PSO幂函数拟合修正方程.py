...
def pso1(X, Y, num_particles=80, max_iter=300,
        bounds=((0.0, 6.0), (1.0, 3.0), (2.0, 3.0), (-1.0, 1.0)),  # 四个参数的范围
...
# 运行粒子群优化 修正
bounds = ((0.001, 10.0), (1.0, 3.0), (2.0, 3.0), (-1.0, 1.0))  # 对 k, alpha, beta, gamma的范围设置
...
# 预测
k_best, alpha_best, beta_best, gamma_best = best_params
y_pred_train = steinmetz_equation(x_train['温度，oC'], x_train['频率，Hz'], x_train['磁通密度峰值'], k_best,
                                          alpha_best, beta_best, gamma_best)
